...
import com.skillshoft.spingboot.model.User;
import com.skillshoft.spingboot.service.EmailService;
...
public class RegistrationController {
    ...
    public ModelAndView processRegistrationForm(ModelAndView modelAndView, @Valid User user, BindingResult bindingResult, HttpServletRequest request){
        ...
        if (bindingResult.hasErrors()){
            ...
            String message = "To set you password, please click on the link below:\n"
                    + appUrl + "confirm?token" + user.getConfirmationToken();

            emailService.sendMail(user.getEmail(),"Please set a password", message);

            modelAndView.addObject("confirmationMessage", "A password set e-mail has been set to " + user.getEmail());
            modelAndView.setViewName("register");
        }
